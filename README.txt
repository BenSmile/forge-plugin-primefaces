...
- *primefaces set-theme* (press Enter) -> You can choose from a list of available Primefaces themes.
- *primefaces install-CSV* -> Activated the Primefaces Client Side Validation framework (config in web.xml)
